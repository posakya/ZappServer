...
if ($conn->connect_error) {
 ...
 if(isset($_POST['btnsave']))
 {
  ...
  if(!isset($errMSG))
  {
   $sql = "INSERT INTO newari(Image,Iname,Price) VALUES('$imgFile','$iname','$Price')";
   $conn->query($sql);
   if($conn)
   {
...
$iname = $_POST['Iname'];
$sql = "delete from newari where Iname = '".$iname."'";
$conn->query($sql);
if($conn){
...
$sql =("UPDATE newari SET Image = '$imgFile', Iname = '$iname', Price = '$Price' WHERE  Iname = '".$iname."'");
$conn->query($sql);
if($conn){

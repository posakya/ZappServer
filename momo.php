...
if ($conn->connect_error) {
 ...
 if(isset($_POST['btnsave']))
 {
  ...
  if(!isset($errMSG))
  {
   $sql = "INSERT INTO momo(Image,Iname,Price) VALUES('$imgFile','$iname','$Price')";
   $conn->query($sql);
   if($conn)
   {
    echo "new record succesfully inserted ...";
    header("refresh:5;chowmien.php"); // redirects image view page after 5 seconds.
   }
   else
   {
...
$iname = $_POST['Iname'];
$sql = "delete from momo where Iname = '".$iname."'";
$conn->query($sql);
if($conn){
...
$sql =("UPDATE momo SET Image = '$imgFile', Iname = '$iname',  Price = '$Price' WHERE  Iname = '".$iname."'");
$conn->query($sql);
if($conn){
